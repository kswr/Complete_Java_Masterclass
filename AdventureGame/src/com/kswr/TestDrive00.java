...
public class TestDrive00 {
    ...
    public static void main(String[] args) {
        ...
        locations.put(0, new Location(0, "You are sitting in front of a compuer learning Java", null));
        ...
        tempExit = new HashMap<>();
        tempExit.put("W", 1);
        locations.put(3, new Location(3, "You are inide a building, a well house for a small spring",tempExit));
        ...
        while (true) {
            ...
            for (String string : directions) {
                ...
                if (dictionary.containsKey(string)) {
                    loc = exits.get(dictionary.get(string));
                    break;
                }
            }
            if (loc == tempLoc) {
