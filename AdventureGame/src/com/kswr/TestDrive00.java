...
public class TestDrive00 {
    ...
    public static void main(String[] args) {
        ...
        locations.put(0, new Location(0, "You are sitting in front of a compuer learning Java"));
        locations.put(1, new Location(1, "You are standing at the end of a road before a small brick building"));
        locations.put(2, new Location(2, "You are at the top of the hill"));
        locations.put(3, new Location(3, "You are inide a building, a well house for a small spring"));
